...
# Embedded color definitions (aligned with ~/.cache/hyde/wallbash/gtk.css)
declare -A color_defs
color_defs=(
  ["background"]="#<wallbash_pry1>"      # #192429
  ["foreground"]="#<wallbash_txt1>"      # #FFFFFF
  ["border"]="#<wallbash_1xa8>"          # #AADAF0
  ["button-background"]="#<wallbash_1xa8>" # #AADAF0
  ["button-foreground"]="#<wallbash_pry1>" # #192429
  ["button-hover-background"]="#<wallbash_1xa7>" # #9ACEE6
  ["critical-foreground"]="#<wallbash_4xa7>" # #E6CD9A
  ["secondary-text"]="#<wallbash_1xa8>"  # #AADAF0
  ["mpris-gradient"]="#<wallbash_1xa9>"  # #CCEFFF
)
